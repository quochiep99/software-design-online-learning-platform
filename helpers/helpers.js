        ...
        <div class="card-header" role="tab" id="heading${sectionNumberInString}">
            <h5 class="mb-0">
                <a data-toggle="collapse" href="#collapse${sectionNumberInString}" aria-expanded="true"
                    aria-controls="collapse${sectionNumberInString}"><i class="indicator ti-minus"></i>${sectionName}</a>
            </h5>
        </div>

        <div id="collapse${sectionNumberInString}" class="collapse show" role="tabpanel" aria-labelledby="heading${sectionNumberInString}"
