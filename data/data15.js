module.exports = {
    ...
    "course": {
        ...
        "reviews": [],
        "students": [],
        "image1xURL": "https://img-a.udemycdn.com/course/240x135/1352468_3d97_7.jpg",
        "image2xURL": "https://img-a.udemycdn.com/course/480x270/1352468_3d97_7.jpg",
        "image3xURL": "https://img-a.udemycdn.com/course/750x422/1352468_3d97_7.jpg",
        "discountPrice": 18.99,
    ...
    "reviews": [
        {
            "body": "Learn lots of things regarding micro services and spring cloud. Thanks Ranga! for this excellent tutorial",
            "rating": 4.5
        },
        {
        ...
        {
            "body": "Many Spring cloud topics are not covered. The course name should be Spring cloud basics and not - \"Mastering\" microservices with cloud. Also, asked few questions but did not receive any response.",
            "rating": 3
        },
        {
        ...
        {
            "body": "Trainer had very well explained through out the course and the course content was also helpful. It helped me a lot to get more knowledge on Spring Boot and Spring Cloud Course. I'm grateful to the trainers Mahi, Ranga,Helen for all your assistance whenever i raised a query. Especially, many many Thanks to Ranga for the great course especially to assist me and providing with an exposure on lot of concepts.",
            "rating": 4.5
        },
        {
            "body": "Very good explanations , would recommend anybody looking to get started with spring microservices / jpa",
            "rating": 4
        },
        {
            "body": "Instructor is has a good teaching skill and is well versed with spring framework. Video's are short and upto the point.\n\nTitle is misleading... The course is mere introduction to microservices, the core microservices concepts were taught for less than 2 hours. So it lacks depth.\n\nWe can call this course a great introduction to microservices nothing more. Failed to explain different architecture patterns eg. event driven architecture, etc.\n\nFailed to explain the configuration of components like rabbitmq, zuul,etc.\n\nits incomplete, most of the course content appears to be re-purposed videos from previous courses.\n\nYou wouldn't be able to deploy any real world project after this course.",
            "rating": 2.5
        },
        {
            "body": "Examples are good. but need to explain why each component designed in spring boot and what are advantages and what components it replaces currently in market",
            "rating": 3.5
        },
        {
        ...
        {
            "body": "Straight forward lectures. Well presented. Use the dependencies he is using even though it is a little out dated. It will make the course easier to follow.",
            "rating": 5
        },
        {
            "body": "All the concepts together at one place helps us a lot. One issue is that all the codes are not fully updated like few codes are deprecated and not working and giving error and we are clueless how to fix it easily. Needs updated code in Notes section would have been great.",
            "rating": 4
        },
        {
            "body": "I have attended this course after having already studied on my own and worked on most of the topics. The course was very useful to put order in what I have studied and to acquire more confidence in applying this knowledge in the practice and to compare my experience with that of the trainer and other students. I have appreciated the way the course has been prepared, the sequence of the topics, the completeness and the way it is updated following the evolution of the frameworks.",
            "rating": 4.5
        }
    ],
    "students": [
        ...
        {
            "name": "Jaykumar Shinde",
            "email": "jaykumarshinde@gmail.com",
            "password": "jaykumarshinde",
            "role": "s"
        },
        {
        ...
        {
            "name": "Dhruthi Nooka",
            "email": "dhruthinooka@gmail.com",
            "password": "dhruthinooka",
            "role": "s"
        },
        {
            "name": "Rahul K Jain",
            "email": "rahulkjain@gmail.com",
            "password": "rahulkjain",
            "role": "s"
        },
        {
            "name": "Pratiek Sanklecha",
            "email": "pratieksanklecha@gmail.com",
            "password": "pratieksanklecha",
            "role": "s"
        },
        {
            "name": "Soumya Mishra",
            "email": "soumyamishra@gmail.com",
            "password": "soumyamishra",
            "role": "s"
        },
        {
        ...
        {
            "name": "Earl Manley",
            "email": "earlmanley@gmail.com",
            "password": "earlmanley",
            "role": "s"
        },
        {
            "name": "Zaryab Saiyadain",
            "email": "zaryabsaiyadain@gmail.com",
            "password": "zaryabsaiyadain",
            "role": "s"
        },
        {
            "name": "Carlo G.",
            "email": "carlog.@gmail.com",
            "password": "carlog.",
            "role": "s"
        }
    ],
